...
static NSString *reportCellId;
#import "PublicReportViewController.h"
#import "BaseModel.h"
#import "PublicReportTableViewCell.h"
#import "DetailViewController.h"

@interface PublicReportViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    PublicReportTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:reportCellId];
    if (!cell) {
        cell = [[PublicReportTableViewCell alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, 60)];
    }
...
- (void)requestDataWithTag:(NSInteger)tag {
    ...
    NSString *url_apiPath = [[NSString alloc]initWithFormat:@"findReportInfo.action"];
