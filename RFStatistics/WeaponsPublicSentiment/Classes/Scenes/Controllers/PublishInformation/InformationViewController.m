...
@interface InformationViewController ()<SGTopTitleViewDelegate,UIScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    self.topTitleView = [SGTopTitleView topTitleViewWithFrame:CGRectMake(0, 64, kScreenWidth, 44)];
    _topTitleView.scrollTitleArr = [NSArray arrayWithArray:_titlesArray];
    _topTitleView.titleAndIndicatorColor = RGBAlphaColorValue(0X2a7a80);
...
- (void)showVc:(NSInteger)index {
    CGFloat offsetX = index * self.view.frame.size.width;
    BaseTableViewController *vc = self.tableViewsArray[index];
